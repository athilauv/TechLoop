...
public sealed class AnalyticsRepository : IAnalyticsRepository
{
    ...
    public Task<AnalyticsOverviewResponse?> GetOverviewAsync(Guid userId, CancellationToken cancellationToken)
    {
        const string sql = "SELECT * FROM fn_analytics_overview(@UserId);";
        return WithConnection(connection => connection.QuerySingleOrDefaultAsync<AnalyticsOverviewResponse>(
                new CommandDefinition(sql, new { UserId = userId }, cancellationToken: cancellationToken)));
    }

    public Task<IReadOnlyList<PracticeActivityResponse>> GetPracticeActivityAsync(Guid userId, CancellationToken cancellationToken)
    {
    ...
    public Task<IReadOnlyList<TechnologyPracticeResponse>> GetTechnologyPracticeAsync(Guid userId, CancellationToken cancellationToken)
    {
    ...
    public Task<IReadOnlyList<TopicAnalyticsResponse>> GetTopicAnalyticsAsync(Guid userId, CancellationToken cancellationToken)
    {
    ...
    public Task<IReadOnlyList<DifficultyProgressionResponse>> GetDifficultyProgressionAsync(Guid userId, CancellationToken cancellationToken)
    {
    ...
    public Task<IReadOnlyList<DailyActivityResponse>> GetDailyActivityAsync(Guid userId, CancellationToken cancellationToken)
    {
