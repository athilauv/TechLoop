...
public sealed class TopicRepository : ITopicsRepository
{
    ...
    public Task<bool> ExistsAsync(int technologyId, string title, CancellationToken cancellationToken)
    {
    ...
    public Task<bool> PositionExistsAsync(int technologyId, int position, CancellationToken cancellationToken)
    {
    return WithConnection(async connection =>
    {
    ...
    // Create a new topic.
    public Task<int> CreateAsync(Topic topic, bool shiftPositions, CancellationToken cancellationToken)
    {
    return WithConnection(async connection =>
    {
    ...
    public Task<MentorTopicResponse?> GetMentorByIdAsync(int id, CancellationToken cancellationToken)
    {
    return WithConnection(async connection =>
    {
    ...
    public Task<int> UpdateAsync(Topic topic, bool shiftPositions, CancellationToken cancellationToken)
    {
    return WithConnection(async connection =>
    {
    ...
    public Task<IEnumerable<Topic>> GetAllAsync(CancellationToken cancellationToken)
    {
    return WithConnection(async connection =>
    {
    ...
    public Task<IEnumerable<MentorTopicResponse>> GetAllMentorAsync(Guid mentorId, CancellationToken cancellationToken)
    {
    return WithConnection(async connection =>
    {
    ...
    // Publish a topic.
    public Task<int> PublishAsync(Topic topic, CancellationToken cancellationToken)
    {
    return WithConnection(async connection =>
    {
    ...
    public Task<IEnumerable<Topic>> GetPublishedAsync(CancellationToken cancellationToken)
    {
    return WithConnection(async connection =>
    {
    ...
    public Task<Topic?> GetPublishedBySlugAsync(string slug, CancellationToken cancellationToken)
    {
    return WithConnection(async connection =>
    {
    ...
    public Task<int?> GetTechnologyIdAsync(int topicId, CancellationToken cancellationToken)
    {
    return WithConnection(async connection =>
    {
    ...
    public Task<IEnumerable<MentorTopicResponse>>
