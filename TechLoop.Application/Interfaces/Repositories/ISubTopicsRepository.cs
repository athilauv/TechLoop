...
public interface ISubTopicsRepository
{
    ...
    Task<int> CreateAsync(SubTopic subTopic, bool shiftPositions, CancellationToken cancellationToken);
    Task<int> UpdateAsync(SubTopic subTopic, bool shiftPositions, CancellationToken cancellationToken);
