...
import { deleteQuestion, getMentorQuestionById, publishQuestion } from "../../../../../api/mentorQuestion.api.ts";
...
const McqQuestionDetailsPage = () => {
    ...
    const initialTab = requestedTab && validInitialTabs.has(requestedTab) ? requestedTab : "overview";
    ...
    if (isError || !question || question.questionType !== QuestionType.Mcq) {
        return (
            <div className="px-6 py-6">
                <EmptyState icon={<FileQuestion size={24} />}
                    title="Question not found"
                    description="The requested question could not be found."
                />
            </div>
