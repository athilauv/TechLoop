    ...
    return (
        <button
            ...
            className={[
                ...
                available ? "border-[var(--cs-border)] bg-[var(--cs-surface)] hover:-translate-y-0.5 hover:border-[var(--cs-primary)]/40 hover:bg-[var(--cs-surface-muted)]" : "cursor-not-allowed border-[var(--cs-border)] bg-[var(--cs-surface)] opacity-60",
            ].join(" ")}
        >
            <div className="flex items-start justify-between gap-4">
                ...
                {available ? (
                    <ChevronRight size={19} className="mt-1 shrink-0 text-[var(--cs-text-muted)] transition-transform group-hover:translate-x-1 group-hover:text-[var(--cs-primary)]"/>
                ) : (
            ...
            <h2 className="mt-5 text-base font-semibold text-[var(--cs-text)]">
                {title}
            </h2>
            ...
            <div className="mx-auto mt-6 max-w-6xl">
                <div>
                    ...
                    <p className="mt-1 max-w-2xl text-sm leading-6 text-[var(--cs-text-muted)]">
                        Create and manage questions for
                        learners across different question
                        types.
                    </p>
                </div>
...
export default MentorQuestionsPage;