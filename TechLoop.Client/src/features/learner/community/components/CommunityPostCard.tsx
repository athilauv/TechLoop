...
export default function CommunityPostCard({
    ...
    const normalizedPostUserId =
        post.userId?.trim().toLowerCase();
    ...
    const avatarLetter =
        post.userName?.trim().charAt(0).toUpperCase() || "U";
                ...
                >
                    ...
                    <div className="min-w-0">
                        <div className="flex items-center gap-2">
                            ...
                            {post.userRoleId === 2 && (
                                <span className="rounded-full border border-[#17D4C3]/30 bg-[#17D4C3]/10 px-1.5 py-0.5 text-[8px] font-semibold uppercase tracking-wide text-[#17D4C3]">
                                    Mentor
                                </span>
                            )}
                        </div>
            ...
            {editing ? (
                <div className="mt-5">
                    <input
                        ...
                        maxLength={200}
                        disabled={savingEdit}
                        className="w-full rounded-xl border border-[#1e3254] bg-[#081423] px-4 py-3 text-sm font-semibold text-white outline-none placeholder:text-[#526d8e] focus:border-[#17D4C3] disabled:opacity-60"
                    />
                    ...
                    <textarea
                        ...
                        maxLength={5000}
                        disabled={savingEdit}
                        className="mt-3 w-full resize-none rounded-xl border border-[#1e3254] bg-[#081423] px-4 py-3 text-sm leading-6 text-white outline-none placeholder:text-[#526d8e] focus:border-[#17D4C3] disabled:opacity-60"
                    />
                    ...
                    <div className="mt-3 flex items-center justify-end gap-2">
                        <button
                            ...
                            onClick={cancelEdit}
                            disabled={savingEdit}
                            className="inline-flex items-center gap-1.5 rounded-lg px-3 py-2 text-xs font-medium text-[#7189a8] transition hover:bg-[#10283e] hover:text-white disabled:cursor-not-allowed disabled:opacity-50"
                        >
                            <X size={13} />
                            Cancel
                        </button>
