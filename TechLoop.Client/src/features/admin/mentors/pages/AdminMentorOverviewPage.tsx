...
export default function AdminMentorOverviewPage() {
    ...
    if (isError || !data) return <div className="p-6 lg:p-10 text-sm text-[#F87171]">Mentor overview could not be loaded.</div>;
    return <div className="p-6 lg:p-10">
        <AdminPageHeader eyebrow="Mentor overview" title={data.username} description={`${data.email} · ${data.technologyName}`} />
