...
import type { AdminBadgeTone } from "../components/AdminBadge.tsx";

/**
 * Presentation-only helpers that turn the numeric enum values already used
 * by the API into human-readable labels/badge tones for the admin UI.
 * These do not change the underlying values sent to or received from the
 * backend — they only affect how the values are displayed.
 */
