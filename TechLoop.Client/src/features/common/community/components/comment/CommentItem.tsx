...
export default function CommentItem({
    ...
    async function handleEdit() {
        ...
        if (!onEdit) {
            showToast.error("Comment update is not available.");
            return;
        }
            ...
            <div className="space-y-2" style={indentStyle}>
                <div className="rounded-xl border border-[#1e3254] bg-[#081423] p-3">
                    ...
                    <textarea
                        ...
                        maxLength={1000}
                        disabled={savingEdit}
                        className="mt-3 w-full resize-none rounded-xl border border-[#1e3254] bg-[#06111f] px-3 py-2.5 text-xs leading-5 text-white outline-none placeholder:text-[#526d8e] focus:border-[#17D4C3] disabled:opacity-60"
                    />
