...
const CodingQuestionPage = () => {
    ...
    const starterCode = useMemo(() => {
        return templates[0]?.starterCode ?? "";
    }, [templates]);
    ...
    const handleRunCode = () => {
        ...
        toast.info(
            "Run Code is not implemented yet."
        );
    };
        ...
        try {
            ...
            if (axios.isAxiosError(error)) {
                ...
                if (error.response?.status === 409) {
                    ...
                    toast.error(
                        "Unable to submit your solution. Please try again."
                    );
                }
            } else {
                toast.error(
