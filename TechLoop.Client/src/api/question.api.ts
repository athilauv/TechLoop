...
import type {
    ...
    SubmitMcqAnswerResponse } from "../types/question.types.ts";
...
export const getQuestionDetails = async (
    ...
    const { data } = await api.get(`/questions/${questionId}/details`);
    return data;
};
...
export const getMcqOptions = async (
    ...
    const { data } = await api.get<LearnerMcqOption[]>(`/questions/questions/${questionId}/mcq-options`);
    return data;
};
...
export const getCodingTemplates = async (
    ...
    const { data } = await api.get<LearnerCodingTemplate[]>(`/questions/questions/${questionId}/coding-templates`);
    return data;
};
...
export const getTestCases = async (
    ...
    const { data } = await api.get<LearnerTestCase[]>(`/questions/questions/${questionId}/test-cases`);
    return data;
};
...
export const getMcqQuestionBySubTopic = async (
    ...
    const { data } = await api.get<LearnerMcqQuestion | null>(`/questions/sub-topic/${subTopicId}/mcq`);
    return data;
};
