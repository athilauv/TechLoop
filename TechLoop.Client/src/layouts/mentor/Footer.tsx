...
const footerLinks = [
    { title: "Platform", links: ["Learn", "Practice", "Coding", "AI Mentor"] },
        ...
        <footer className="border-t border-white/5 bg-[#0A1930]">
            <div className="mx-auto max-w-[1440px] px-8 py-10">
                <div className="grid gap-10 md:grid-cols-[2fr_1fr_1fr_1fr]">
                    <div>
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h2 className="text-lg font-semibold text-white">TechLoop</h2>
                                <p className="text-sm text-slate-500">Learn • Practice • Build</p>
                            </div>
                        </div>
                        ...
                        <div className="mt-6 flex gap-3">
                            <button
                                ...
                                className="flex h-10 w-10 items-center justify-center rounded-lg border border-white/5 text-slate-400 transition hover:border-[#17D4C3]/30 hover:text-[#17D4C3]"
                            >
                ...
                <div className="mt-10 flex flex-col items-center justify-between gap-3 border-t border-white/5 pt-6 text-sm text-slate-500 md:flex-row">
                    <p>© {new Date().getFullYear()} TechLoop. All rights reserved.</p>
