...
const Navbar = ({ onOpenMobileSidebar, sidebarCollapsed }: NavbarProps) => {
    ...
    const name = stored.username || currentUser?.userId || "Admin";

    return (
        <header
            className={[
                "fixed right-0 top-0 z-30 h-16 border-b border-white/5 bg-[#0E192A]/95 backdrop-blur-md transition-all duration-300",
        ...
        >
            <div className="flex h-full items-center justify-between px-4 md:px-6">
                <div className="flex items-center gap-3">
                    ...
                    <h1 className="hidden text-lg font-semibold text-white lg:block">TechLoop</h1>
                </div>
